...
--
-- New users are now created with is_approved = false and must be approved
-- by a coach or admin before they can log in.
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- 2. Recreate the auth trigger so new signups get is_approved = false
-- ---------------------------------------------------------------------------
...
BEGIN
    ...
    INSERT INTO public.user_profiles (user_id, group_id, display_name, email, birthdate, is_approved)
    VALUES (new_user_id, user_group_id, display_name, NEW.email, user_birthdate, false);
